  ...
  | q=quantifier bs=binders DOT trigger=trigger e=noSeqTerm
      {
        ...
        | _ ->
          ...
          mk_term (q (bs, attr, (idents, trigger), e)) (rhs2 parseState 1 5) Formula
      }
  ...
  | LBRACE_COLON_NOPATTERN_RBRACE
      {
        ...
        let ident = mk_ident ("nopattern", r) in
        ((Some ident), [])
      }
  | LBRACE_COLON_PATTERN pats=disjunctivePats RBRACE { (None, pats) }
