  ...
  fun env  ->
    fun probs  ->
      fun err  ->
        ...
        (let uu____27844 =
           FStar_Profiling.profile (fun uu____27851  -> solve env probs)
             (fun uu____27853  ->
                FStar_Common.string_of_list
                  (fun p  -> FStar_Util.string_of_int (p_pid p))
                  probs.attempting) FStar_Options.ProfileSMT
            in
              ...
              (match sol with
               | Success (deferred,implicits) ->
                   let uu____27885 =
                     FStar_Util.record_time
                       (fun uu____27892  -> FStar_Syntax_Unionfind.commit tx)
                      in
                   (match uu____27885 with
                    | ((),ms1) ->
                        ((let uu____27903 =
                          ...
                          if uu____27903
                          then
                            let uu____27908 = FStar_Util.string_of_int ms1
                               in
               ...
               | Failed (d,s) ->
                   ((let uu____27922 =
                     ...
                     if uu____27922
                     then
                       let uu____27929 = explain env d s  in
    ...
    fun g  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ((let uu____27956 =
            ...
            if uu____27956
            then
              let uu____27961 = FStar_Syntax_Print.term_to_string f  in
           ...
           (let f1 =
            ...
            (let uu____27968 =
             ...
             if uu____27968
             then
               let uu____27973 = FStar_Syntax_Print.term_to_string f1  in
               FStar_Util.print1 "Simplified guard to %s\n" uu____27973
             else ());
            (let f2 =
               let uu____27979 =
                 let uu____27980 = FStar_Syntax_Util.unmeta f1  in
                 uu____27980.FStar_Syntax_Syntax.n  in
               match uu____27979 with
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.true_lid
                   -> FStar_TypeChecker_Common.Trivial
               | uu____27984 -> FStar_TypeChecker_Common.NonTrivial f1  in
             let uu___3703_27985 = g  in
             {
               FStar_TypeChecker_Env.guard_f = f2;
               FStar_TypeChecker_Env.deferred =
                 (uu___3703_27985.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___3703_27985.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___3703_27985.FStar_TypeChecker_Env.implicits)
             })))
              ...
              let uu____28041 =
                let uu____28042 =
                  FStar_All.pipe_right (p_guard prob)
                    (fun _28043  ->
                       FStar_TypeChecker_Common.NonTrivial _28043)
                   in
                {
                  FStar_TypeChecker_Env.guard_f = uu____28042;
                  FStar_TypeChecker_Env.deferred = deferred;
                  FStar_TypeChecker_Env.univ_ineqs = ([], []);
                  FStar_TypeChecker_Env.implicits = implicits
                }  in
              simplify_guard env uu____28041  in
            FStar_All.pipe_left
              (fun _28050  -> FStar_Pervasives_Native.Some _28050)
              uu____28040
      ...
      fun dopt  ->
        ...
        | FStar_Pervasives_Native.Some d ->
            let uu____28083 =
              let uu____28084 =
                FStar_All.pipe_right (p_guard prob)
                  (fun _28085  -> FStar_TypeChecker_Common.NonTrivial _28085)
                 in
              {
                FStar_TypeChecker_Env.guard_f = uu____28084;
                FStar_TypeChecker_Env.deferred = d;
                FStar_TypeChecker_Env.univ_ineqs = ([], []);
                FStar_TypeChecker_Env.implicits = []
              }  in
            FStar_Pervasives_Native.Some uu____28083
      ...
      fun t1  ->
        fun t2  ->
          (let uu____28118 =
           ...
           if uu____28118
           then
             let uu____28123 = FStar_Syntax_Print.term_to_string t1  in
             let uu____28125 = FStar_Syntax_Print.term_to_string t2  in
             FStar_Util.print2 "try_teq of %s and %s\n" uu____28123
               uu____28125
           else ());
          (let uu____28130 =
             let uu____28135 = FStar_TypeChecker_Env.get_range env  in
               ...
               let g =
                 let uu____28143 =
                   solve_and_commit env (singleton wl prob smt_ok)
                     (fun uu____28153  -> FStar_Pervasives_Native.None)
                    in
                 FStar_All.pipe_left (with_guard env prob) uu____28143  in
               g)
...
let (teq :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____28189 = try_teq true env t1 t2  in
        ...
        | FStar_Pervasives_Native.Some g ->
            ((let uu____28203 =
              ...
              if uu____28203
              then
                let uu____28208 = FStar_Syntax_Print.term_to_string t1  in
                let uu____28210 = FStar_Syntax_Print.term_to_string t2  in
                let uu____28212 = guard_to_string env g  in
                FStar_Util.print3
                  "teq of %s and %s succeeded with guard %s\n" uu____28208
                  uu____28210 uu____28212
              else ());
             g)
...
let (subtype_fail :
  ...
  fun env  ->
    fun e  ->
      fun t1  ->
        fun t2  ->
          let uu____28238 = FStar_TypeChecker_Env.get_range env  in
          let uu____28239 =
            FStar_TypeChecker_Err.basic_type_error env
              (FStar_Pervasives_Native.Some e) t2 t1
             in
          FStar_Errors.log_issue uu____28238 uu____28239
      ...
      fun c2  ->
        ...
        (let uu____28268 =
         ...
         then
           ...
           let uu____28275 = FStar_Syntax_Print.comp_to_string c2  in
           FStar_Util.print3 "sub_comp of %s --and-- %s --with-- %s\n"
             uu____28273 uu____28275
             (if rel = FStar_TypeChecker_Common.EQ then "EQ" else "SUB")
         else ());
        (let uu____28286 =
           let uu____28293 = FStar_TypeChecker_Env.get_range env  in
           new_problem (empty_worklist env) env c1 rel c2
             FStar_Pervasives_Native.None uu____28293 "sub_comp"
            in
              ...
              (let uu____28306 =
                   ...
                   (fun uu____28318  ->
                      let uu____28319 =
                        solve_and_commit env (singleton wl prob1 true)
                          (fun uu____28330  -> FStar_Pervasives_Native.None)
                         in
                      FStar_All.pipe_left (with_guard env prob1) uu____28319)
                  in
               ...
               | (r,ms) ->
                   ((let uu____28361 =
                     ...
                     if uu____28361
                     then
                       let uu____28366 = FStar_Syntax_Print.comp_to_string c1
                          in
                       let uu____28368 = FStar_Syntax_Print.comp_to_string c2
                          in
                       let uu____28370 = FStar_Util.string_of_int ms  in
                       FStar_Util.print4
                         "sub_comp of %s --and-- %s --with-- %s --- solved in %s ms\n"
                         uu____28366 uu____28368
                         (if rel = FStar_TypeChecker_Common.EQ
                          then "EQ"
                          else "SUB") uu____28370
                     else ());
                    r))))
      ...
      fun uu____28408  ->
        ...
        | (variables,ineqs) ->
            let fail1 u1 u2 =
              ...
              (let uu____28451 =
                 let uu____28457 =
                   let uu____28459 = FStar_Syntax_Print.univ_to_string u1  in
                   let uu____28461 = FStar_Syntax_Print.univ_to_string u2  in
                   FStar_Util.format2 "Universe %s and %s are incompatible"
                     uu____28459 uu____28461
                    in
                 (FStar_Errors.Fatal_IncompatibleUniverse, uu____28457)  in
               let uu____28465 = FStar_TypeChecker_Env.get_range env  in
               FStar_Errors.raise_error uu____28451 uu____28465)
               in
            let equiv1 v1 v' =
              let uu____28478 =
                let uu____28483 = FStar_Syntax_Subst.compress_univ v1  in
                let uu____28484 = FStar_Syntax_Subst.compress_univ v'  in
                (uu____28483, uu____28484)  in
              match uu____28478 with
              | (FStar_Syntax_Syntax.U_unif v0,FStar_Syntax_Syntax.U_unif
                 v0') -> FStar_Syntax_Unionfind.univ_equiv v0 v0'
              | uu____28504 -> false  in
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v1  ->
                      ...
                      | FStar_Syntax_Syntax.U_unif uu____28542 ->
                            ...
                            FStar_All.pipe_right ineqs
                              (FStar_List.collect
                                 (fun uu____28571  ->
                                    ...
                                    | (u,v') ->
                                        let uu____28580 = equiv1 v1 v'  in
                                        if uu____28580
                                        then
                                          let uu____28585 =
                                            FStar_All.pipe_right variables
            ...
            let uu____28611 =
              let wl =
                let uu___3794_28615 = empty_worklist env  in
                {
                  attempting = (uu___3794_28615.attempting);
                  wl_deferred = (uu___3794_28615.wl_deferred);
                  ctr = (uu___3794_28615.ctr);
                  defer_ok = false;
                  smt_ok = (uu___3794_28615.smt_ok);
                  umax_heuristic_ok = (uu___3794_28615.umax_heuristic_ok);
                  tcenv = (uu___3794_28615.tcenv);
                  wl_implicits = (uu___3794_28615.wl_implicits)
                }  in
              FStar_All.pipe_right sols
               ...
               in
            let rec check_ineq uu____28655 =
              ...
              | (u,v1) ->
                  ...
                  (match (u1, v2) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____28667) -> true
                   | (FStar_Syntax_Syntax.U_succ
                   ...
                   | (FStar_Syntax_Syntax.U_name
                      uu____28691,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_unif
                      uu____28693,FStar_Syntax_Syntax.U_succ v0) ->
                       check_ineq (u1, v0)
                   | (FStar_Syntax_Syntax.U_max us,uu____28704) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u2  -> check_ineq (u2, v2)))
                   | (uu____28712,FStar_Syntax_Syntax.U_max vs) ->
              ...
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____28744  ->
                      ...
                      | (u,v1) ->
                          let uu____28752 = check_ineq (u, v1)  in
                          if uu____28752
                          then true
                          else
                            ((let uu____28760 =
                              ...
                              then
                                ...
                                FStar_Util.print2 "%s </= %s" uu____28765
                                  uu____28767
                              else ());
                             false)))
               in
            ...
            then ()
              ...
              ((let uu____28777 =
                ...
                if uu____28777
                then
                  ((let uu____28783 = ineqs_to_string (variables, ineqs)  in
                    FStar_Util.print1
                      "Partially solved inequality constraints are: %s\n"
                      uu____28783);
                   FStar_Syntax_Unionfind.rollback tx;
                   (let uu____28795 = ineqs_to_string (variables, ineqs)  in
                    FStar_Util.print1
                      "Original solved inequality constraints are: %s\n"
                      uu____28795))
                else ());
               (let uu____28808 = FStar_TypeChecker_Env.get_range env  in
    ...
    fun env  ->
      fun g  ->
        ...
        let wl =
          ...
          {
            attempting = (uu___3871_28908.attempting);
            wl_deferred = (uu___3871_28908.wl_deferred);
            ctr = (uu___3871_28908.ctr);
            defer_ok;
            smt_ok = (uu___3871_28908.smt_ok);
            umax_heuristic_ok = (uu___3871_28908.umax_heuristic_ok);
            tcenv = (uu___3871_28908.tcenv);
            wl_implicits = (uu___3871_28908.wl_implicits)
          }  in
        (let uu____28911 =
           FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
             (FStar_Options.Other "Rel")
         ...
         if uu____28911
         then
           let uu____28916 = FStar_Util.string_of_bool defer_ok  in
           let uu____28918 = wl_to_string wl  in
           let uu____28920 =
             FStar_Util.string_of_int
           ...
           FStar_Util.print3
             ...
             uu____28916 uu____28918 uu____28920
         else ());
        (let g1 =
           let uu____28926 = solve_and_commit env wl fail1  in
           match uu____28926 with
           | FStar_Pervasives_Native.Some
               (uu____28933::uu____28934,uu____28935) when
               Prims.op_Negation defer_ok ->
               failwith "Impossible: Unexpected deferred constraints remain"
           | FStar_Pervasives_Native.Some (deferred,imps) ->
               let uu___3886_28964 = g  in
               {
                 FStar_TypeChecker_Env.guard_f =
                   (uu___3886_28964.FStar_TypeChecker_Env.guard_f);
                 FStar_TypeChecker_Env.deferred = deferred;
                 FStar_TypeChecker_Env.univ_ineqs =
                   (uu___3886_28964.FStar_TypeChecker_Env.univ_ineqs);
                 FStar_TypeChecker_Env.implicits =
         ...
         (let uu___3891_28974 = g1  in
          {
            FStar_TypeChecker_Env.guard_f =
              (uu___3891_28974.FStar_TypeChecker_Env.guard_f);
            FStar_TypeChecker_Env.deferred =
              (uu___3891_28974.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs = ([], []);
            FStar_TypeChecker_Env.implicits =
              (uu___3891_28974.FStar_TypeChecker_Env.implicits)
          }))
...
let (maybe_update_proof_ns : FStar_TypeChecker_Env.env -> unit) =
  fun env  ->
    ...
    let uu____29017 = FStar_ST.op_Bang last_proof_ns  in
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___3910_29142 = g1  in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___3910_29142.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___3910_29142.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___3910_29142.FStar_TypeChecker_Env.implicits)
            }  in
          let uu____29143 =
            let uu____29145 = FStar_TypeChecker_Env.should_verify env  in
            Prims.op_Negation uu____29145  in
          if uu____29143
          then FStar_Pervasives_Native.Some ret_g
            ...
            (match g1.FStar_TypeChecker_Env.guard_f with
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 (if debug1
                  then
                    (let uu____29157 = FStar_TypeChecker_Env.get_range env
                        in
                     let uu____29158 =
                       let uu____29160 = FStar_Syntax_Print.term_to_string vc
                          in
                       FStar_Util.format1 "Before normalization VC=\n%s\n"
                         uu____29160
                        in
                     FStar_Errors.diag uu____29157 uu____29158)
                  else ();
                  (let vc1 =
                     FStar_TypeChecker_Normalize.normalize
                       [FStar_TypeChecker_Env.Eager_unfolding;
                   ...
                   if debug1
                   then
                     (let uu____29168 = FStar_TypeChecker_Env.get_range env
                         in
                      let uu____29169 =
                        let uu____29171 =
                        ...
                        FStar_Util.format1 "After normalization VC=\n%s\n"
                          uu____29171
                         in
                      FStar_Errors.diag uu____29168 uu____29169)
                   else ();
                   (let uu____29177 = FStar_TypeChecker_Env.get_range env  in
                    FStar_TypeChecker_Env.def_check_closed_in_env uu____29177
                      "discharge_guard'" env vc1);
                   (let uu____29179 = FStar_TypeChecker_Env.check_trivial vc1
                       in
                             ...
                             (let uu____29188 =
                              ...
                              let uu____29189 =
                                ...
                                FStar_Util.format1
                                  ...
                                  uu____29191
                                 in
                              FStar_Errors.diag uu____29188 uu____29189)
                           else ();
                           FStar_Pervasives_Native.None)
                        else
                          (if debug1
                             ...
                             (let uu____29201 =
                              ...
                              let uu____29202 =
                                ...
                                FStar_Util.format1 "Checking VC=\n%s\n"
                                  uu____29204
                                 in
                              FStar_Errors.diag uu____29201 uu____29202)
                           else ();
                           (let vcs =
                              let uu____29218 = FStar_Options.use_tactics ()
                                 in
                              if uu____29218
                              then
                                              ...
                                              | (env1,goal,opts) ->
                                                  let uu____29302 =
                                                    FStar_TypeChecker_Normalize.normalize
                                                      ...
                                                      env1 goal
                                                     in
                                                  (env1, uu____29302, opts)))))
                              else
                                (let uu____29305 =
                                   let uu____29312 = FStar_Options.peek ()
                                      in
                                   (env, vc2, uu____29312)  in
                                 [uu____29305])
                               in
                            FStar_All.pipe_right vcs
                              (FStar_List.iter
                                              ...
                                              then
                                                (let uu____29367 =
                                                 ...
                                                 let uu____29368 =
                                                   ...
                                                   FStar_Util.format2
                                                     "Trying to solve:\n> %s\nWith proof_ns:\n %s\n"
                                                     uu____29370 uu____29372
                                                    in
                                                 FStar_Errors.diag
                                                   uu____29367 uu____29368)
                                              else ();
                                              if debug1
                                              then
                                                (let uu____29379 =
...
let (discharge_guard_no_smt :
  ...
  fun env  ->
    fun g  ->
      ...
      | FStar_Pervasives_Native.None  ->
          let uu____29409 = FStar_TypeChecker_Env.get_range env  in
          FStar_Errors.raise_error
            (FStar_Errors.Fatal_ExpectTrivialPreCondition,
              "Expected a trivial pre-condition") uu____29409
  
let (discharge_guard_with_msg :
  (unit -> Prims.string) FStar_Pervasives_Native.option ->
    FStar_TypeChecker_Env.env ->
      FStar_TypeChecker_Env.guard_t -> FStar_TypeChecker_Env.guard_t)
  =
  fun msg  ->
    fun env  ->
      fun g  ->
        let uu____29439 = discharge_guard' msg env g true  in
...
let (discharge_guard :
  ...
  =
  fun env  ->
    fun g  -> discharge_guard_with_msg FStar_Pervasives_Native.None env g
...
let (teq_nosmt :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____29480 = try_teq false env t1 t2  in
          ...
          let rec unresolved ctx_u =
            ...
            | FStar_Pervasives_Native.Some r ->
                (match ctx_u.FStar_Syntax_Syntax.ctx_uvar_meta with
                 ...
                 | FStar_Pervasives_Native.Some uu____29537 ->
                     let uu____29550 =
                       let uu____29551 = FStar_Syntax_Subst.compress r  in
                       uu____29551.FStar_Syntax_Syntax.n  in
                     (match uu____29550 with
                      | FStar_Syntax_Syntax.Tm_uvar (ctx_u',uu____29556) ->
                          unresolved ctx_u'
                      | uu____29573 -> false))
            | FStar_Pervasives_Native.None  -> true  in
          let rec until_fixpoint acc implicits =
            let uu____29597 = acc  in
                     ...
                     (match uu____29616 with
                      | { FStar_TypeChecker_Env.imp_reason = reason;
                          ...
                          then until_fixpoint (out, true) tl1
                            ...
                            (let uu____29627 = unresolved ctx_u  in
                             if uu____29627
                             then
                                   ...
                                   ((let uu____29651 =
                                    ...
                                    (let t =
                                       env1.FStar_TypeChecker_Env.synth_hook
                                        ...
                                        in
                                     let extra =
                                       let uu____29664 = teq_nosmt env1 t tm
                                          in
                                       match uu____29664 with
                                       | FStar_Pervasives_Native.None  ->
                                           failwith
                                       ...
                                       | FStar_Pervasives_Native.Some g1 ->
                                        ...
                                        in
                                     let ctx_u1 =
                                       let uu___4026_29674 = ctx_u  in
                                       {
                                         FStar_Syntax_Syntax.ctx_uvar_head =
                                           (uu___4026_29674.FStar_Syntax_Syntax.ctx_uvar_head);
                                         FStar_Syntax_Syntax.ctx_uvar_gamma =
                                           (uu___4026_29674.FStar_Syntax_Syntax.ctx_uvar_gamma);
                                         FStar_Syntax_Syntax.ctx_uvar_binders
                                           =
                                           (uu___4026_29674.FStar_Syntax_Syntax.ctx_uvar_binders);
                                         FStar_Syntax_Syntax.ctx_uvar_typ =
                                           (uu___4026_29674.FStar_Syntax_Syntax.ctx_uvar_typ);
                                         FStar_Syntax_Syntax.ctx_uvar_reason
                                           =
                                           (uu___4026_29674.FStar_Syntax_Syntax.ctx_uvar_reason);
                                         FStar_Syntax_Syntax.ctx_uvar_should_check
                                           =
                                           (uu___4026_29674.FStar_Syntax_Syntax.ctx_uvar_should_check);
                                         FStar_Syntax_Syntax.ctx_uvar_range =
                                           (uu___4026_29674.FStar_Syntax_Syntax.ctx_uvar_range);
                                         FStar_Syntax_Syntax.ctx_uvar_meta =
                                           FStar_Pervasives_Native.None
                                       }  in
                                     let hd2 =
                                       let uu___4029_29682 = hd1  in
                                       {
                                         FStar_TypeChecker_Env.imp_reason =
                                           (uu___4029_29682.FStar_TypeChecker_Env.imp_reason);
                                         FStar_TypeChecker_Env.imp_uvar =
                                           ctx_u1;
                                         FStar_TypeChecker_Env.imp_tm =
                                           (uu___4029_29682.FStar_TypeChecker_Env.imp_tm);
                                         FStar_TypeChecker_Env.imp_range =
                                           (uu___4029_29682.FStar_TypeChecker_Env.imp_range)
                                       }  in
                               ...
                               then until_fixpoint (out, true) tl1
                                 ...
                                 (let env1 =
                                    let uu___4033_29693 = env  in
                                    {
                                      FStar_TypeChecker_Env.solver =
                                        (uu___4033_29693.FStar_TypeChecker_Env.solver);
                                      FStar_TypeChecker_Env.range =
                                        (uu___4033_29693.FStar_TypeChecker_Env.range);
                                      FStar_TypeChecker_Env.curmodule =
                                        (uu___4033_29693.FStar_TypeChecker_Env.curmodule);
                                      FStar_TypeChecker_Env.gamma =
                                        (ctx_u.FStar_Syntax_Syntax.ctx_uvar_gamma);
                                      FStar_TypeChecker_Env.gamma_sig =
                                        (uu___4033_29693.FStar_TypeChecker_Env.gamma_sig);
                                      FStar_TypeChecker_Env.gamma_cache =
                                        (uu___4033_29693.FStar_TypeChecker_Env.gamma_cache);
                                      FStar_TypeChecker_Env.modules =
                                        (uu___4033_29693.FStar_TypeChecker_Env.modules);
                                      FStar_TypeChecker_Env.expected_typ =
                                        (uu___4033_29693.FStar_TypeChecker_Env.expected_typ);
                                      FStar_TypeChecker_Env.sigtab =
                                        (uu___4033_29693.FStar_TypeChecker_Env.sigtab);
                                      FStar_TypeChecker_Env.attrtab =
                                        (uu___4033_29693.FStar_TypeChecker_Env.attrtab);
                                      FStar_TypeChecker_Env.is_pattern =
                                        (uu___4033_29693.FStar_TypeChecker_Env.is_pattern);
                                      FStar_TypeChecker_Env.instantiate_imp =
                                        (uu___4033_29693.FStar_TypeChecker_Env.instantiate_imp);
                                      FStar_TypeChecker_Env.effects =
                                        (uu___4033_29693.FStar_TypeChecker_Env.effects);
                                      FStar_TypeChecker_Env.generalize =
                                        (uu___4033_29693.FStar_TypeChecker_Env.generalize);
                                      FStar_TypeChecker_Env.letrecs =
                                        (uu___4033_29693.FStar_TypeChecker_Env.letrecs);
                                      FStar_TypeChecker_Env.top_level =
                                        (uu___4033_29693.FStar_TypeChecker_Env.top_level);
                                      FStar_TypeChecker_Env.check_uvars =
                                        (uu___4033_29693.FStar_TypeChecker_Env.check_uvars);
                                      FStar_TypeChecker_Env.use_eq =
                                        (uu___4033_29693.FStar_TypeChecker_Env.use_eq);
                                      FStar_TypeChecker_Env.is_iface =
                                        (uu___4033_29693.FStar_TypeChecker_Env.is_iface);
                                      FStar_TypeChecker_Env.admit =
                                        (uu___4033_29693.FStar_TypeChecker_Env.admit);
                                      FStar_TypeChecker_Env.lax =
                                        (uu___4033_29693.FStar_TypeChecker_Env.lax);
                                      FStar_TypeChecker_Env.lax_universes =
                                        (uu___4033_29693.FStar_TypeChecker_Env.lax_universes);
                                      FStar_TypeChecker_Env.phase1 =
                                        (uu___4033_29693.FStar_TypeChecker_Env.phase1);
                                      FStar_TypeChecker_Env.failhard =
                                        (uu___4033_29693.FStar_TypeChecker_Env.failhard);
                                      FStar_TypeChecker_Env.nosynth =
                                        (uu___4033_29693.FStar_TypeChecker_Env.nosynth);
                                      FStar_TypeChecker_Env.uvar_subtyping =
                                        (uu___4033_29693.FStar_TypeChecker_Env.uvar_subtyping);
                                      FStar_TypeChecker_Env.tc_term =
                                        (uu___4033_29693.FStar_TypeChecker_Env.tc_term);
                                      FStar_TypeChecker_Env.type_of =
                                        (uu___4033_29693.FStar_TypeChecker_Env.type_of);
                                      FStar_TypeChecker_Env.universe_of =
                                        (uu___4033_29693.FStar_TypeChecker_Env.universe_of);
                                      FStar_TypeChecker_Env.check_type_of =
                                        (uu___4033_29693.FStar_TypeChecker_Env.check_type_of);
                                      FStar_TypeChecker_Env.use_bv_sorts =
                                        (uu___4033_29693.FStar_TypeChecker_Env.use_bv_sorts);
                                      FStar_TypeChecker_Env.qtbl_name_and_index
                                        =
                                        (uu___4033_29693.FStar_TypeChecker_Env.qtbl_name_and_index);
                                      FStar_TypeChecker_Env.normalized_eff_names
                                        =
                                        (uu___4033_29693.FStar_TypeChecker_Env.normalized_eff_names);
                                      FStar_TypeChecker_Env.fv_delta_depths =
                                        (uu___4033_29693.FStar_TypeChecker_Env.fv_delta_depths);
                                      FStar_TypeChecker_Env.proof_ns =
                                        (uu___4033_29693.FStar_TypeChecker_Env.proof_ns);
                                      FStar_TypeChecker_Env.synth_hook =
                                        (uu___4033_29693.FStar_TypeChecker_Env.synth_hook);
                                      FStar_TypeChecker_Env.splice =
                                        (uu___4033_29693.FStar_TypeChecker_Env.splice);
                                      FStar_TypeChecker_Env.postprocess =
                                        (uu___4033_29693.FStar_TypeChecker_Env.postprocess);
                                      FStar_TypeChecker_Env.is_native_tactic
                                        =
                                        (uu___4033_29693.FStar_TypeChecker_Env.is_native_tactic);
                                      FStar_TypeChecker_Env.identifier_info =
                                        (uu___4033_29693.FStar_TypeChecker_Env.identifier_info);
                                      FStar_TypeChecker_Env.tc_hooks =
                                        (uu___4033_29693.FStar_TypeChecker_Env.tc_hooks);
                                      FStar_TypeChecker_Env.dsenv =
                                        (uu___4033_29693.FStar_TypeChecker_Env.dsenv);
                                      FStar_TypeChecker_Env.nbe =
                                        (uu___4033_29693.FStar_TypeChecker_Env.nbe)
                                    }  in
                                  let tm1 =
                                    FStar_TypeChecker_Normalize.normalize
                                  ...
                                  let env2 =
                                    if forcelax
                                    then
                                      let uu___4038_29697 = env1  in
                                      {
                                        FStar_TypeChecker_Env.solver =
                                          (uu___4038_29697.FStar_TypeChecker_Env.solver);
                                        FStar_TypeChecker_Env.range =
                                          (uu___4038_29697.FStar_TypeChecker_Env.range);
                                        FStar_TypeChecker_Env.curmodule =
                                          (uu___4038_29697.FStar_TypeChecker_Env.curmodule);
                                        FStar_TypeChecker_Env.gamma =
                                          (uu___4038_29697.FStar_TypeChecker_Env.gamma);
                                        FStar_TypeChecker_Env.gamma_sig =
                                          (uu___4038_29697.FStar_TypeChecker_Env.gamma_sig);
                                        FStar_TypeChecker_Env.gamma_cache =
                                          (uu___4038_29697.FStar_TypeChecker_Env.gamma_cache);
                                        FStar_TypeChecker_Env.modules =
                                          (uu___4038_29697.FStar_TypeChecker_Env.modules);
                                        FStar_TypeChecker_Env.expected_typ =
                                          (uu___4038_29697.FStar_TypeChecker_Env.expected_typ);
                                        FStar_TypeChecker_Env.sigtab =
                                          (uu___4038_29697.FStar_TypeChecker_Env.sigtab);
                                        FStar_TypeChecker_Env.attrtab =
                                          (uu___4038_29697.FStar_TypeChecker_Env.attrtab);
                                        FStar_TypeChecker_Env.is_pattern =
                                          (uu___4038_29697.FStar_TypeChecker_Env.is_pattern);
                                        FStar_TypeChecker_Env.instantiate_imp
                                          =
                                          (uu___4038_29697.FStar_TypeChecker_Env.instantiate_imp);
                                        FStar_TypeChecker_Env.effects =
                                          (uu___4038_29697.FStar_TypeChecker_Env.effects);
                                        FStar_TypeChecker_Env.generalize =
                                          (uu___4038_29697.FStar_TypeChecker_Env.generalize);
                                        FStar_TypeChecker_Env.letrecs =
                                          (uu___4038_29697.FStar_TypeChecker_Env.letrecs);
                                        FStar_TypeChecker_Env.top_level =
                                          (uu___4038_29697.FStar_TypeChecker_Env.top_level);
                                        FStar_TypeChecker_Env.check_uvars =
                                          (uu___4038_29697.FStar_TypeChecker_Env.check_uvars);
                                        FStar_TypeChecker_Env.use_eq =
                                          (uu___4038_29697.FStar_TypeChecker_Env.use_eq);
                                        FStar_TypeChecker_Env.is_iface =
                                          (uu___4038_29697.FStar_TypeChecker_Env.is_iface);
                                        FStar_TypeChecker_Env.admit =
                                          (uu___4038_29697.FStar_TypeChecker_Env.admit);
                                        FStar_TypeChecker_Env.lax = true;
                                        FStar_TypeChecker_Env.lax_universes =
                                          (uu___4038_29697.FStar_TypeChecker_Env.lax_universes);
                                        FStar_TypeChecker_Env.phase1 =
                                          (uu___4038_29697.FStar_TypeChecker_Env.phase1);
                                        FStar_TypeChecker_Env.failhard =
                                          (uu___4038_29697.FStar_TypeChecker_Env.failhard);
                                        FStar_TypeChecker_Env.nosynth =
                                          (uu___4038_29697.FStar_TypeChecker_Env.nosynth);
                                        FStar_TypeChecker_Env.uvar_subtyping
                                          =
                                          (uu___4038_29697.FStar_TypeChecker_Env.uvar_subtyping);
                                        FStar_TypeChecker_Env.tc_term =
                                          (uu___4038_29697.FStar_TypeChecker_Env.tc_term);
                                        FStar_TypeChecker_Env.type_of =
                                          (uu___4038_29697.FStar_TypeChecker_Env.type_of);
                                        FStar_TypeChecker_Env.universe_of =
                                          (uu___4038_29697.FStar_TypeChecker_Env.universe_of);
                                        FStar_TypeChecker_Env.check_type_of =
                                          (uu___4038_29697.FStar_TypeChecker_Env.check_type_of);
                                        FStar_TypeChecker_Env.use_bv_sorts =
                                          (uu___4038_29697.FStar_TypeChecker_Env.use_bv_sorts);
                                        FStar_TypeChecker_Env.qtbl_name_and_index
                                          =
                                          (uu___4038_29697.FStar_TypeChecker_Env.qtbl_name_and_index);
                                        FStar_TypeChecker_Env.normalized_eff_names
                                          =
                                          (uu___4038_29697.FStar_TypeChecker_Env.normalized_eff_names);
                                        FStar_TypeChecker_Env.fv_delta_depths
                                          =
                                          (uu___4038_29697.FStar_TypeChecker_Env.fv_delta_depths);
                                        FStar_TypeChecker_Env.proof_ns =
                                          (uu___4038_29697.FStar_TypeChecker_Env.proof_ns);
                                        FStar_TypeChecker_Env.synth_hook =
                                          (uu___4038_29697.FStar_TypeChecker_Env.synth_hook);
                                        FStar_TypeChecker_Env.splice =
                                          (uu___4038_29697.FStar_TypeChecker_Env.splice);
                                        FStar_TypeChecker_Env.postprocess =
                                          (uu___4038_29697.FStar_TypeChecker_Env.postprocess);
                                        FStar_TypeChecker_Env.is_native_tactic
                                          =
                                          (uu___4038_29697.FStar_TypeChecker_Env.is_native_tactic);
                                        FStar_TypeChecker_Env.identifier_info
                                          =
                                          (uu___4038_29697.FStar_TypeChecker_Env.identifier_info);
                                        FStar_TypeChecker_Env.tc_hooks =
                                          (uu___4038_29697.FStar_TypeChecker_Env.tc_hooks);
                                        FStar_TypeChecker_Env.dsenv =
                                          (uu___4038_29697.FStar_TypeChecker_Env.dsenv);
                                        FStar_TypeChecker_Env.nbe =
                                          (uu___4038_29697.FStar_TypeChecker_Env.nbe)
                                      }
                                    else env1  in
                                  (let uu____29702 =
                                     FStar_All.pipe_left
                                   ...
                                   then
                                     ...
                                     FStar_Util.print5
                                       ...
                                       uu____29707 uu____29709 uu____29711
                                       reason uu____29713
                                   else ());
                                  (let g1 =
                                     try
                                   ...
                                   let g2 =
                                     ...
                                     then
                                       let uu___4052_29771 = g1  in
                                       {
                                         FStar_TypeChecker_Env.guard_f =
                                           FStar_TypeChecker_Common.Trivial;
                                         FStar_TypeChecker_Env.deferred =
                                           (uu___4052_29771.FStar_TypeChecker_Env.deferred);
                                         FStar_TypeChecker_Env.univ_ineqs =
                                           (uu___4052_29771.FStar_TypeChecker_Env.univ_ineqs);
                                         FStar_TypeChecker_Env.implicits =
                                           (uu___4052_29771.FStar_TypeChecker_Env.implicits)
                                       }
                                     else g1  in
                                   let g' =
                                     let uu____29775 =
                                         ...
                                         (FStar_Pervasives_Native.Some
                                            (fun uu____29786  ->
                                               ...
                                               FStar_Util.format4
                                                 ...
                                                 uu____29787 uu____29789
                                                 reason uu____29791)) env2 g2
                                         true
                                        in
                                   ...
                                   until_fixpoint
                                     ((FStar_List.append
                                         ...
                                         out), true) tl1)))))
             in
          let uu___4060_29799 = g  in
          let uu____29800 =
            until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits  in
          {
            FStar_TypeChecker_Env.guard_f =
              (uu___4060_29799.FStar_TypeChecker_Env.guard_f);
            FStar_TypeChecker_Env.deferred =
              (uu___4060_29799.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___4060_29799.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits = uu____29800
          }
...
let (force_trivial_guard :
  ...
  fun env  ->
    fun g  ->
      let g1 =
        let uu____29843 = solve_deferred_constraints env g  in
        FStar_All.pipe_right uu____29843 (resolve_implicits env)  in
      match g1.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____29844 = discharge_guard env g1  in
          FStar_All.pipe_left (fun a2  -> ()) uu____29844
      | imp::uu____29846 ->
          let uu____29849 =
            let uu____29855 =
              let uu____29857 =
              ...
              FStar_Util.format3
                ...
                uu____29857 uu____29859 imp.FStar_TypeChecker_Env.imp_reason
               in
            (FStar_Errors.Fatal_FailToResolveImplicitArgument, uu____29855)
             in
          FStar_Errors.raise_error uu____29849
...
let (teq_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____29881 = teq_nosmt env t1 t2  in
...
let (universe_inequality :
  ...
  fun u1  ->
    fun u2  ->
      let uu___4082_29900 = FStar_TypeChecker_Env.trivial_guard  in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___4082_29900.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___4082_29900.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___4082_29900.FStar_TypeChecker_Env.implicits)
      }
             ...
             let g =
               let uu____29967 =
                 solve_and_commit env (singleton wl prob true)
                   (fun uu____29978  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____29967  in
             ((let uu____29999 =
                 (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                    (FStar_Options.Other "Rel"))
               ...
               then
                 ...
                 let uu____30006 =
                   FStar_TypeChecker_Normalize.term_to_string env t2  in
                 let uu____30008 =
                   let uu____30010 = FStar_Util.must g  in
                   guard_to_string env uu____30010  in
                 FStar_Util.print3
                   "check_subtyping succeeded: %s <: %s\n\tguard is %s\n"
                   uu____30004 uu____30006 uu____30008
               else ());
              (match g with
               | FStar_Pervasives_Native.None  ->
                   FStar_Pervasives_Native.None
...
let (get_subtyping_predicate :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30047 = check_subtyping env t1 t2  in
        match uu____30047 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____30066 =
              let uu____30067 = FStar_Syntax_Syntax.mk_binder x  in
              FStar_TypeChecker_Env.abstract_guard uu____30067 g  in
            FStar_Pervasives_Native.Some uu____30066
...
let (get_subtyping_prop :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30086 = check_subtyping env t1 t2  in
        match uu____30086 with
        | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
        | FStar_Pervasives_Native.Some (x,g) ->
            let uu____30105 =
              let uu____30106 =
                let uu____30107 = FStar_Syntax_Syntax.mk_binder x  in
                [uu____30107]  in
              FStar_TypeChecker_Env.close_guard env uu____30106 g  in
            FStar_Pervasives_Native.Some uu____30105
             ...
             let g =
               let uu____30172 =
                 solve_and_commit env (singleton wl prob false)
                   (fun uu____30183  -> FStar_Pervasives_Native.None)
                  in
               FStar_All.pipe_left (with_guard env prob) uu____30172  in
             (match g with
              | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
              | FStar_Pervasives_Native.Some g1 ->
                  let g2 =
                    let uu____30207 =
                      ...
                      [uu____30208]  in
                    FStar_TypeChecker_Env.close_guard env uu____30207 g1  in
...
let (subtype_nosmt_force :
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____30249 = subtype_nosmt env t1 t2  in
