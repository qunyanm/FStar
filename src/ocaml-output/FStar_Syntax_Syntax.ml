...
and metadata =
  | Meta_pattern of (FStar_Ident.ident FStar_Pervasives_Native.option * term'
  syntax Prims.list * (term' syntax * arg_qualifier
...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uinst _0 -> true | uu____1768 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_constant _0 -> true | uu____1805 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_type _0 -> true | uu____1824 -> false
...
let (uu___is_Tm_abs : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_abs _0 -> true | uu____1861 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_arrow _0 -> true | uu____1948 -> false
...
let (uu___is_Tm_refine : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_refine _0 -> true | uu____2015 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_app _0 -> true | uu____2068 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_match _0 -> true | uu____2157 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_ascribed _0 -> true | uu____2268 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_let _0 -> true | uu____2378 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_uvar _0 -> true | uu____2448 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_delayed _0 -> true | uu____2525 -> false
...
let (uu___is_Tm_meta : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_meta _0 -> true | uu____2616 -> false
...
let (uu___is_Tm_lazy : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_lazy _0 -> true | uu____2653 -> false
...
let (uu___is_Tm_quoted : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_quoted _0 -> true | uu____2678 -> false
...
let (uu___is_Tm_unknown : term' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Tm_unknown  -> true | uu____2714 -> false
...
let (uu___is_Pat_constant : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_constant _0 -> true | uu____3148 -> false
  
let (__proj__Pat_constant__item___0 : pat' -> sconst) =
  fun projectee  -> match projectee with | Pat_constant _0 -> _0 
let (uu___is_Pat_cons : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_cons _0 -> true | uu____3180 -> false
...
let (uu___is_Pat_var : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_var _0 -> true | uu____3238 -> false
  
let (__proj__Pat_var__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_var _0 -> _0 
let (uu___is_Pat_wild : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_wild _0 -> true | uu____3257 -> false
  
let (__proj__Pat_wild__item___0 : pat' -> bv) =
  fun projectee  -> match projectee with | Pat_wild _0 -> _0 
let (uu___is_Pat_dot_term : pat' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Pat_dot_term _0 -> true | uu____3282 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Total _0 -> true | uu____3745 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | GTotal _0 -> true | uu____3796 -> false
...
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Comp _0 -> true | uu____3839 -> false
  
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee  -> match projectee with | Comp _0 -> _0 
let (uu___is_TOTAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | TOTAL  -> true | uu____3857 -> false
  
let (uu___is_MLEFFECT : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | MLEFFECT  -> true | uu____3868 -> false
  
let (uu___is_LEMMA : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | LEMMA  -> true | uu____3879 -> false
  
let (uu___is_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | RETURN  -> true | uu____3890 -> false
  
let (uu___is_PARTIAL_RETURN : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | PARTIAL_RETURN  -> true | uu____3901 -> false
  
let (uu___is_SOMETRIVIAL : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SOMETRIVIAL  -> true | uu____3912 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | SHOULD_NOT_INLINE  -> true | uu____3934 -> false
  
let (uu___is_CPS : cflag -> Prims.bool) =
  fun projectee  -> match projectee with | CPS  -> true | uu____3945 -> false 
let (uu___is_DECREASES : cflag -> Prims.bool) =
  fun projectee  ->
    match projectee with | DECREASES _0 -> true | uu____3959 -> false
...
let (__proj__Meta_pattern__item___0 :
  metadata ->
    (FStar_Ident.ident FStar_Pervasives_Native.option * term' syntax
      Prims.list * (term' syntax * arg_qualifier
      FStar_Pervasives_Native.option) Prims.list Prims.list))
  = fun projectee  -> match projectee with | Meta_pattern _0 -> _0 
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_named _0 -> true | uu____4099 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_labeled _0 -> true | uu____4126 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_desugared _0 -> true | uu____4169 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic _0 -> true | uu____4194 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____4239 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sequence  -> true | uu____4281 -> false
  
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Primop  -> true | uu____4292 -> false
  
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Masked_effect  -> true | uu____4303 -> false
  
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee  ->
    match projectee with | Meta_smt_pat  -> true | uu____4314 -> false
  
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Data_ctor  -> true | uu____4325 -> false
  
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_projector _0 -> true | uu____4341 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee  ->
    match projectee with | Record_ctor _0 -> true | uu____4378 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | DB _0 -> true | uu____4420 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NM _0 -> true | uu____4459 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | NT _0 -> true | uu____4499 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UN _0 -> true | uu____4541 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee  ->
    match projectee with | UD _0 -> true | uu____4580 -> false
...
let (uu___is_BadLazy : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | BadLazy  -> true | uu____4951 -> false
  
let (uu___is_Lazy_bv : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_bv  -> true | uu____4962 -> false
  
let (uu___is_Lazy_binder : lazy_kind -> Prims.bool) =
  fun projectee  ->
    match projectee with | Lazy_binder  -> true | uu____4973 -> false
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____7426 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_bundle _0 -> true | uu____7501 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_datacon _0 -> true | uu____7559 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_declare_typ _0 -> true | uu____7629 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_let _0 -> true | uu____7672 -> false
...
let (uu___is_Sig_main : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_main _0 -> true | uu____7709 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_assume _0 -> true | uu____7734 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_new_effect _0 -> true | uu____7771 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_sub_effect _0 -> true | uu____7809 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____7840 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_pragma _0 -> true | uu____7895 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee  ->
    match projectee with | Sig_splice _0 -> true | uu____7920 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l  ->
    FStar_Util.for_some
      (fun uu___0_8142  ->
         match uu___0_8142 with
         | Reflectable uu____8144 -> true
         | uu____8146 -> false) l
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x  ->
    fun r  ->
      let uu___422_8264 = x  in
      let uu____8265 =
        FStar_Ident.mk_ident (((x.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____8265;
        index = (uu___422_8264.index);
        sort = (uu___422_8264.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____8302  ->
             ...
             | (bv,t) -> let uu____8313 = f t  in (bv, uu____8313))
          qi.antiquotes
         in
      let uu___430_8314 = qi  in
      { qkind = (uu___430_8314.qkind); antiquotes = aq }
  ...
  fun bv  ->
    fun aq  ->
      let uu____8330 =
        FStar_List.tryFind
          (fun uu____8348  ->
             match uu____8348 with | (bv',uu____8357) -> bv_eq bv bv') aq
         in
      match uu____8330 with
      | FStar_Pervasives_Native.Some (uu____8364,e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None  -> FStar_Pervasives_Native.None
  
let syn :
  'Auu____8395 'Auu____8396 'Auu____8397 .
    'Auu____8395 ->
      'Auu____8396 ->
        ('Auu____8396 -> 'Auu____8395 -> 'Auu____8397) -> 'Auu____8397
...
let mk_uvs :
  'Auu____8445 .
    unit -> 'Auu____8445 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____8454  -> FStar_Util.mk_ref FStar_Pervasives_Native.None 
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____8464  -> FStar_Util.new_set order_bv 
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____8474  -> FStar_Util.new_set order_ident 
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____8484  -> FStar_Util.new_set order_fv 
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x  ->
    fun y  ->
      let uu____8499 = FStar_Ident.text_of_id x  in
      let uu____8501 = FStar_Ident.text_of_id y  in
      FStar_String.compare uu____8499 uu____8501
  
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____8510  -> FStar_Util.new_set order_univ_name 
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1  ->
    fun b2  ->
      match (b1, b2) with
      | (Binding_var bv1,Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1,uu____8529),Binding_lid (lid2,uu____8531)) ->
...
let mk : 'a . 'a -> 'a mk_t_a =
  fun t  ->
    fun uu____8620  ->
      fun r  ->
        let uu____8624 = FStar_Util.mk_ref FStar_Pervasives_Native.None  in
        { n = t; pos = r; vars = uu____8624 }
  
let (bv_to_tm : bv -> term) =
  fun bv  ->
    let uu____8635 = range_of_bv bv  in
    mk (Tm_bvar bv) FStar_Pervasives_Native.None uu____8635
  
let (bv_to_name : bv -> term) =
  fun bv  ->
    let uu____8642 = range_of_bv bv  in
    mk (Tm_name bv) FStar_Pervasives_Native.None uu____8642
...
let (binders_to_names : binders -> term Prims.list) =
  fun bs  ->
    FStar_All.pipe_right bs
      (FStar_List.map
         (fun uu____8672  ->
            match uu____8672 with | (x,uu____8680) -> bv_to_name x))
...
let (mk_Tm_uinst : term -> universes -> term) =
  fun t  ->
    fun uu___1_8735  ->
      match uu___1_8735 with
      | [] -> t
      | us ->
          (match t.n with
           | Tm_fvar uu____8737 ->
               mk (Tm_uinst (t, us)) FStar_Pervasives_Native.None t.pos
           | uu____8740 -> failwith "Unexpected universe instantiation")
    ...
    fun args'  ->
      fun kopt  ->
        fun r  ->
          ...
          | uu____8799 -> mk_Tm_app t args' kopt r
  ...
  fun lr  ->
    fun pos  ->
      let uu____8856 =
        let uu____8863 =
          let uu____8864 =
            let uu____8887 = FStar_Util.mk_ref FStar_Pervasives_Native.None
               in
            (lr, uu____8887)  in
          Tm_delayed uu____8864  in
        mk uu____8863  in
      uu____8856 FStar_Pervasives_Native.None pos
...
let (is_type : term -> Prims.bool) =
  fun t  -> match t.n with | Tm_type uu____9090 -> true | uu____9092 -> false 
...
let (null_binder : term -> binder) =
  fun t  ->
    let uu____9118 = null_bv t  in (uu____9118, FStar_Pervasives_Native.None)
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___2_9168  ->
    match uu___2_9168 with
    | { lbname = FStar_Util.Inr uu____9172; lbunivs = uu____9173;
        lbtyp = uu____9174; lbeff = uu____9175; lbdef = uu____9176;
        lbattrs = uu____9177; lbpos = uu____9178;_}::uu____9179 -> true
    | uu____9193 -> false
...
let (freenames_of_binders : binders -> freenames) =
  fun bs  ->
    FStar_List.fold_right
      (fun uu____9215  ->
         fun out  ->
           match uu____9215 with | (x,uu____9228) -> FStar_Util.set_add x out)
      bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs  ->
    let uu____9261 = FStar_Util.set_elements fvs  in
    FStar_All.pipe_right uu____9261 binders_of_list
  
let (is_implicit : aqual -> Prims.bool) =
  fun uu___3_9272  ->
    match uu___3_9272 with
    | FStar_Pervasives_Native.Some (Implicit uu____9274) -> true
    | uu____9277 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p  ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____9323 -> b
      | Pat_constant uu____9330 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____9333,pats) ->
          FStar_List.fold_left
            (fun b1  ->
               fun uu____9367  ->
                 match uu____9367 with | (p2,uu____9380) -> aux b1 p2) b pats
       in
    let uu____9387 = aux [] p  in
    FStar_All.pipe_left FStar_List.rev uu____9387
  
let (range_of_ropt :
  FStar_Range.range FStar_Pervasives_Native.option -> FStar_Range.range) =
  fun uu___5_9401  ->
    match uu___5_9401 with
  ...
  fun s  ->
    fun r  ->
      fun t  ->
        ...
        let uu____9441 = FStar_Ident.next_id ()  in
        { ppname = id1; index = uu____9441; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv  ->
    let uu____9464 = is_null_bv bv  in
    if uu____9464
    then
      let uu____9467 =
        let uu____9470 = range_of_bv bv  in
        FStar_Pervasives_Native.Some uu____9470  in
      new_bv uu____9467 bv.sort
    else
      (let uu___611_9473 = bv  in
       let uu____9474 = FStar_Ident.next_id ()  in
       {
         ppname = (uu___611_9473.ppname);
         index = uu____9474;
         sort = (uu___611_9473.sort)
       })
...
let (freshen_binder : binder -> binder) =
  fun b  ->
    ...
    | (bv,aq) -> let uu____9489 = freshen_bv bv  in (uu____9489, aq)
...
let (new_univ_name :
  ...
  fun ropt  ->
    ...
    let uu____9504 =
      let uu____9510 =
        let uu____9512 = FStar_Util.string_of_int id1  in
        Prims.op_Hat FStar_Ident.reserved_prefix uu____9512  in
      (uu____9510, (range_of_ropt ropt))  in
    FStar_Ident.mk_ident uu____9504
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv  ->
    fun r  ->
      let uu___641_9643 = bv  in
      let uu____9644 =
        FStar_Ident.mk_ident (((bv.ppname).FStar_Ident.idText), r)  in
      {
        ppname = uu____9644;
        index = (uu___641_9643.index);
        sort = (uu___641_9643.sort)
      }
...
let (lid_as_fv :
  ...
  fun l  ->
    fun dd  ->
      fun dq  ->
        let uu____9666 =
          let uu____9667 = FStar_Ident.range_of_lid l  in
          withinfo l uu____9667  in
        { fv_name = uu____9666; fv_delta = dd; fv_qual = dq }
  
let (fv_to_tm : fv -> term) =
  fun fv  ->
    let uu____9674 = FStar_Ident.range_of_lid (fv.fv_name).v  in
    mk (Tm_fvar fv) FStar_Pervasives_Native.None uu____9674
...
let (fvar :
  ...
  fun l  ->
    fun dd  ->
      fun dq  -> let uu____9695 = lid_as_fv l dd dq  in fv_to_tm uu____9695
  
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv  -> (fv.fv_name).v 
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv  ->
    let uu____9708 = lid_of_fv fv  in FStar_Ident.range_of_lid uu____9708
  
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv  ->
    fun r  ->
      let uu___654_9720 = fv  in
      let uu____9721 =
        let uu___656_9722 = fv.fv_name  in
        let uu____9723 =
          let uu____9724 = lid_of_fv fv  in
          FStar_Ident.set_lid_range uu____9724 r  in
        { v = uu____9723; p = (uu___656_9722.p) }  in
      {
        fv_name = uu____9721;
        fv_delta = (uu___654_9720.fv_delta);
        fv_qual = (uu___654_9720.fv_qual)
      }
...
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l  ->
    fun s  ->
      FStar_List.existsb
        (fun uu___6_9750  ->
           match uu___6_9750 with
           | { n = Tm_constant (FStar_Const.Const_string (data,uu____9755));
               pos = uu____9756; vars = uu____9757;_} when data = s -> true
           | uu____9764 -> false) l
  ...
  fun p1  ->
    fun p2  ->
      ...
      | (Pat_cons (fv1,as1),Pat_cons (fv2,as2)) ->
          let uu____9823 = fv_eq fv1 fv2  in
          if uu____9823
          then
            let uu____9828 = FStar_List.zip as1 as2  in
      ...
      | (Pat_var uu____9933,Pat_var uu____9934) -> true
      | (Pat_wild uu____9936,Pat_wild uu____9937) -> true
      | (Pat_dot_term (bv1,t1),Pat_dot_term (bv2,t2)) -> true
      | (uu____9952,uu____9953) -> false
...
let (t_tactic_unit : term) =
  let uu____10021 =
    let uu____10026 =
      let uu____10027 = tabbrev FStar_Parser_Const.tactic_lid  in
      mk_Tm_uinst uu____10027 [U_zero]  in
    let uu____10028 = let uu____10029 = as_arg t_unit  in [uu____10029]  in
...
let (t_list_of : term -> term) =
  fun t  ->
    let uu____10060 =
      let uu____10065 =
        let uu____10066 = tabbrev FStar_Parser_Const.list_lid  in
...
let (t_option_of : term -> term) =
  fun t  ->
    let uu____10099 =
      let uu____10104 =
        let uu____10105 = tabbrev FStar_Parser_Const.option_lid  in
        mk_Tm_uinst uu____10105 [U_zero]  in
      let uu____10106 = let uu____10107 = as_arg t  in [uu____10107]  in
      mk_Tm_app uu____10104 uu____10106  in
    uu____10099 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_tuple2_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10143 =
        let uu____10148 =
          let uu____10149 = tabbrev FStar_Parser_Const.lid_tuple2  in
          mk_Tm_uinst uu____10149 [U_zero; U_zero]  in
        let uu____10150 =
          let uu____10151 = as_arg t1  in
          let uu____10160 = let uu____10171 = as_arg t2  in [uu____10171]  in
          uu____10151 :: uu____10160  in
        mk_Tm_app uu____10148 uu____10150  in
      uu____10143 FStar_Pervasives_Native.None FStar_Range.dummyRange
...
let (t_either_of : term -> term -> term) =
  fun t1  ->
    fun t2  ->
      let uu____10215 =
        let uu____10220 =
          let uu____10221 = tabbrev FStar_Parser_Const.either_lid  in
          mk_Tm_uinst uu____10221 [U_zero; U_zero]  in
        let uu____10222 =
          let uu____10223 = as_arg t1  in
          let uu____10232 = let uu____10243 = as_arg t2  in [uu____10243]  in
