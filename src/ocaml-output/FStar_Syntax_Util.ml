...
type connective =
  | QAll of (FStar_Syntax_Syntax.binders * FStar_Ident.ident
  FStar_Pervasives_Native.option * qpats * FStar_Syntax_Syntax.typ) 
  | QEx of (FStar_Syntax_Syntax.binders * FStar_Ident.ident
  FStar_Pervasives_Native.option * qpats * FStar_Syntax_Syntax.typ) 
  | BaseConn of (FStar_Ident.lident * FStar_Syntax_Syntax.args) 
let (uu___is_QAll : connective -> Prims.bool) =
  fun projectee  ->
    match projectee with | QAll _0 -> true | uu____11563 -> false
  
let (__proj__QAll__item___0 :
  connective ->
    (FStar_Syntax_Syntax.binders * FStar_Ident.ident
      FStar_Pervasives_Native.option * qpats * FStar_Syntax_Syntax.typ))
  = fun projectee  -> match projectee with | QAll _0 -> _0 
let (uu___is_QEx : connective -> Prims.bool) =
  fun projectee  ->
    match projectee with | QEx _0 -> true | uu____11622 -> false
...
let (uu___is_BaseConn : connective -> Prims.bool) =
  fun projectee  ->
    match projectee with | BaseConn _0 -> true | uu____11675 -> false
  ...
  fun f  ->
    let rec unmeta_monadic f1 =
      ...
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic uu____11714) ->
          unmeta_monadic t
      | FStar_Syntax_Syntax.Tm_meta
          (t,FStar_Syntax_Syntax.Meta_monadic_lift uu____11726) ->
          unmeta_monadic t
      | uu____11739 -> f2  in
    let destruct_base_conn f1 =
      ...
      let aux f2 uu____11835 =
        match uu____11835 with
        | (lid,arity) ->
            let uu____11844 =
              let uu____11861 = unmeta_monadic f2  in
              head_and_args uu____11861  in
    ...
    let patterns t =
      ...
      match t1.FStar_Syntax_Syntax.n with
      | FStar_Syntax_Syntax.Tm_meta
          (t2,FStar_Syntax_Syntax.Meta_pattern (attr,uu____11959,pats)) ->
          let uu____12001 = FStar_Syntax_Subst.compress t2  in
          (attr, pats, uu____12001)
      | uu____12016 -> (FStar_Pervasives_Native.None, [], t1)  in
    let destruct_q_conn t =
      let is_q fa fv =
        ...
        then is_forall (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v
         ...
         in
      let flat t1 =
        let uu____12085 = head_and_args t1  in
        match uu____12085 with
        | (t2,args) ->
            let uu____12140 = un_uinst t2  in
            let uu____12141 =
              FStar_All.pipe_right args
                (FStar_List.map
                   (fun uu____12182  ->
                      ...
                      | (t3,imp) ->
                          let uu____12201 = unascribe t3  in
                          (uu____12201, imp)))
               in
            (uu____12140, uu____12141)
         in
      let rec aux qopt out t1 =
        let uu____12252 = let uu____12276 = flat t1  in (qopt, uu____12276)
           in
        match uu____12252 with
        | (FStar_Pervasives_Native.Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.pos = uu____12316;
                 FStar_Syntax_Syntax.vars = uu____12317;_},({
                                                              ...
                                                              FStar_Syntax_Syntax.pos
                                                                = uu____12321;
                                                              FStar_Syntax_Syntax.vars
                                                                = uu____12322;_},uu____12323)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.Some
           fa,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
                 FStar_Syntax_Syntax.pos = uu____12425;
                 FStar_Syntax_Syntax.vars = uu____12426;_},uu____12427::
               ({
                  FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                    (b::[],t2,uu____12430);
                  FStar_Syntax_Syntax.pos = uu____12431;
                  FStar_Syntax_Syntax.vars = uu____12432;_},uu____12433)::[]))
            when is_q fa tc -> aux qopt (b :: out) t2
        | (FStar_Pervasives_Native.None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.pos = uu____12550;
               FStar_Syntax_Syntax.vars = uu____12551;_},({
                                                            FStar_Syntax_Syntax.n
                                                              =
                                                              FStar_Syntax_Syntax.Tm_abs
                                                              (b::[],t2,uu____12554);
            ...
            let uu____12650 =
              let uu____12654 =
                is_forall
                 ...
                 in
              FStar_Pervasives_Native.Some uu____12654  in
            aux uu____12650 (b :: out) t2
        | (FStar_Pervasives_Native.None
           ,({ FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_fvar tc;
               FStar_Syntax_Syntax.pos = uu____12664;
               FStar_Syntax_Syntax.vars = uu____12665;_},uu____12666::
             ({
                FStar_Syntax_Syntax.n = FStar_Syntax_Syntax.Tm_abs
                  (b::[],t2,uu____12669);
                FStar_Syntax_Syntax.pos = uu____12670;
                FStar_Syntax_Syntax.vars = uu____12671;_},uu____12672)::[]))
            when
            is_qlid (tc.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v ->
            let uu____12781 =
              let uu____12785 =
        ...
        | (FStar_Pervasives_Native.Some b,uu____12795) ->
            let bs = FStar_List.rev out  in
            let uu____12848 = FStar_Syntax_Subst.open_term bs t1  in
            (match uu____12848 with
             | (bs1,t2) ->
                 let uu____12857 = patterns t2  in
                 (match uu____12857 with
                  | (attr,pats,body) ->
                      if b
                      then
                        FStar_Pervasives_Native.Some
                          (QAll (bs1, attr, pats, body))
                      else
                        FStar_Pervasives_Native.Some
                          (QEx (bs1, attr, pats, body))))
        | uu____12920 -> FStar_Pervasives_Native.None  in
    ...
    let destruct_sq_base_conn t =
      let uu____13012 = un_squash t  in
      FStar_Util.bind_opt uu____13012
        (fun t1  ->
           let uu____13028 = head_and_args' t1  in
           match uu____13028 with
           | (hd1,args) ->
               let uu____13067 =
                 let uu____13073 =
                   let uu____13074 = un_uinst hd1  in
                   uu____13074.FStar_Syntax_Syntax.n  in
                 (uu____13073, (FStar_List.length args))  in
               (match uu____13067 with
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13090) when
                    (_13090 = (Prims.parse_int "2")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_and_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.and_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13093) when
                    (_13093 = (Prims.parse_int "2")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_or_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.or_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13096) when
                    (_13096 = (Prims.parse_int "2")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq2_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.c_eq2_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13099) when
                    (_13099 = (Prims.parse_int "3")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq2_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.c_eq2_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13102) when
                    (_13102 = (Prims.parse_int "2")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq3_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.c_eq3_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13105) when
                    (_13105 = (Prims.parse_int "4")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_eq3_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.c_eq3_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13108) when
                    (_13108 = (Prims.parse_int "0")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_true_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.true_lid, args))
                | (FStar_Syntax_Syntax.Tm_fvar fv,_13111) when
                    (_13111 = (Prims.parse_int "0")) &&
                      (FStar_Syntax_Syntax.fv_eq_lid fv
                         FStar_Parser_Const.c_false_lid)
                    ->
                    FStar_Pervasives_Native.Some
                      (BaseConn (FStar_Parser_Const.false_lid, args))
                | uu____13112 -> FStar_Pervasives_Native.None))
       in
    let rec destruct_sq_forall t =
      let uu____13142 = un_squash t  in
      FStar_Util.bind_opt uu____13142
        (fun t1  ->
           let uu____13157 = arrow_one t1  in
           match uu____13157 with
           | FStar_Pervasives_Native.Some (b,c) ->
               let uu____13172 =
                 let uu____13174 = is_tot_or_gtot_comp c  in
                 Prims.op_Negation uu____13174  in
               if uu____13172
               then FStar_Pervasives_Native.None
               else
                 (let q =
                    let uu____13184 = comp_to_comp_typ_nouniv c  in
                    uu____13184.FStar_Syntax_Syntax.result_typ  in
                  let uu____13185 =
                    is_free_in (FStar_Pervasives_Native.fst b) q  in
                  if uu____13185
                  then
                    let uu____13192 = patterns q  in
                         ...
                         let uu____13272 =
                           let uu____13273 =
                             FStar_Syntax_Syntax.as_arg
                              ...
                              in
                           let uu____13284 =
                             let uu____13295 = FStar_Syntax_Syntax.as_arg q
                                in
                             [uu____13295]  in
                           uu____13273 :: uu____13284  in
                         (FStar_Parser_Const.imp_lid, uu____13272)  in
                       BaseConn uu____13267  in
                     FStar_Pervasives_Native.Some uu____13266))
           | uu____13328 -> FStar_Pervasives_Native.None)
    
    and destruct_sq_exists t =
      let uu____13336 = un_squash t  in
      FStar_Util.bind_opt uu____13336
        (fun t1  ->
           let uu____13368 = head_and_args' t1  in
           match uu____13368 with
           | (hd1,args) ->
               let uu____13407 =
                 let uu____13422 =
                   let uu____13423 = un_uinst hd1  in
                   uu____13423.FStar_Syntax_Syntax.n  in
                 (uu____13422, args)  in
               (match uu____13407 with
                | (FStar_Syntax_Syntax.Tm_fvar
                   fv,(a1,uu____13440)::(a2,uu____13442)::[]) when
                    FStar_Syntax_Syntax.fv_eq_lid fv
                      FStar_Parser_Const.dtuple2_lid
                    ->
                    let uu____13493 =
                      let uu____13494 = FStar_Syntax_Subst.compress a2  in
                      uu____13494.FStar_Syntax_Syntax.n  in
                    (match uu____13493 with
                     | FStar_Syntax_Syntax.Tm_abs (b::[],q,uu____13501) ->
                         let uu____13536 = FStar_Syntax_Subst.open_term [b] q
                            in
                         (match uu____13536 with
                          | (bs,q1) ->
                              let b1 =
                                match bs with
                                | b1::[] -> b1
                                | uu____13589 -> failwith "impossible"  in
                              let uu____13597 = patterns q1  in
                              (match uu____13597 with
                               | (attr,pats,q2) ->
                                   FStar_All.pipe_left maybe_collect
                                     (FStar_Pervasives_Native.Some
                                        (QEx ([b1], attr, pats, q2)))))
                     | uu____13669 -> FStar_Pervasives_Native.None)
                | uu____13670 -> FStar_Pervasives_Native.None))
    
    and maybe_collect f1 =
      match f1 with
      | FStar_Pervasives_Native.Some (QAll (bs,attr,pats,phi)) ->
          let uu____13698 = destruct_sq_forall phi  in
          (match uu____13698 with
           | FStar_Pervasives_Native.Some (QAll (bs',uu____13704,pats',psi))
               ->
               FStar_All.pipe_left
                 (fun _13713  -> FStar_Pervasives_Native.Some _13713)
                 (QAll
                    ((FStar_List.append bs bs'), attr,
                      (FStar_List.append pats pats'), psi))
           | uu____13722 -> f1)
      | FStar_Pervasives_Native.Some (QEx (bs,attr,pats,phi)) ->
          let uu____13733 = destruct_sq_exists phi  in
          (match uu____13733 with
           | FStar_Pervasives_Native.Some (QEx (bs',uu____13739,pats',psi))
               ->
               FStar_All.pipe_left
                 (fun _13748  -> FStar_Pervasives_Native.Some _13748)
                 (QEx
                    ((FStar_List.append bs bs'), attr,
                      (FStar_List.append pats pats'), psi))
           | uu____13757 -> f1)
    ...
    let uu____13764 = destruct_base_conn phi  in
    FStar_Util.catch_opt uu____13764
      (fun uu____13769  ->
         let uu____13770 = destruct_q_conn phi  in
         FStar_Util.catch_opt uu____13770
           (fun uu____13775  ->
              let uu____13776 = destruct_sq_base_conn phi  in
              FStar_Util.catch_opt uu____13776
                (fun uu____13781  ->
                   let uu____13782 = destruct_sq_forall phi  in
                   FStar_Util.catch_opt uu____13782
                     (fun uu____13787  ->
                        let uu____13788 = destruct_sq_exists phi  in
                        FStar_Util.catch_opt uu____13788
                          (fun uu____13792  -> FStar_Pervasives_Native.None)))))
          ...
          let uu____13810 =
            let uu____13815 =
              FStar_Syntax_Syntax.lid_as_fv a.FStar_Syntax_Syntax.action_name
                ...
                FStar_Pervasives_Native.None
               in
            FStar_Util.Inr uu____13815  in
          let uu____13816 =
            let uu____13817 =
              FStar_Syntax_Syntax.mk_Total a.FStar_Syntax_Syntax.action_typ
               in
            arrow a.FStar_Syntax_Syntax.action_params uu____13817  in
          let uu____13820 =
            abs a.FStar_Syntax_Syntax.action_params
              a.FStar_Syntax_Syntax.action_defn FStar_Pervasives_Native.None
             in
          close_univs_and_mk_letbinding FStar_Pervasives_Native.None
            uu____13810 a.FStar_Syntax_Syntax.action_univs uu____13816
            FStar_Parser_Const.effect_Tot_lid uu____13820 [] pos
           in
        {
  ...
  fun t  ->
    ...
    let uu____13846 =
      let uu____13853 =
        let uu____13854 =
          let uu____13871 =
            let uu____13882 = FStar_Syntax_Syntax.as_arg t  in [uu____13882]
             in
          (reify_1, uu____13871)  in
        FStar_Syntax_Syntax.Tm_app uu____13854  in
      FStar_Syntax_Syntax.mk uu____13853  in
    uu____13846 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
  ...
  fun t  ->
    let reflect_ =
      let uu____13934 =
        let uu____13941 =
          let uu____13942 =
            let uu____13943 = FStar_Ident.lid_of_str "Bogus.Effect"  in
            FStar_Const.Const_reflect uu____13943  in
          FStar_Syntax_Syntax.Tm_constant uu____13942  in
        FStar_Syntax_Syntax.mk uu____13941  in
      uu____13934 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos  in
    let uu____13945 =
      let uu____13952 =
        let uu____13953 =
          let uu____13970 =
            let uu____13981 = FStar_Syntax_Syntax.as_arg t  in [uu____13981]
             in
          (reflect_, uu____13970)  in
        FStar_Syntax_Syntax.Tm_app uu____13953  in
      FStar_Syntax_Syntax.mk uu____13952  in
    uu____13945 FStar_Pervasives_Native.None t.FStar_Syntax_Syntax.pos
...
let rec (delta_qualifier :
  ...
  fun t  ->
    let t1 = FStar_Syntax_Subst.compress t  in
    match t1.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____14025 -> failwith "Impossible"
    | FStar_Syntax_Syntax.Tm_lazy i ->
        let uu____14050 = unfold_lazy i  in delta_qualifier uu____14050
    | FStar_Syntax_Syntax.Tm_fvar fv -> fv.FStar_Syntax_Syntax.fv_delta
    | FStar_Syntax_Syntax.Tm_bvar uu____14052 ->
        FStar_Syntax_Syntax.delta_equational
    | FStar_Syntax_Syntax.Tm_name uu____14053 ->
        FStar_Syntax_Syntax.delta_equational
    | FStar_Syntax_Syntax.Tm_match uu____14054 ->
        FStar_Syntax_Syntax.delta_equational
    | FStar_Syntax_Syntax.Tm_uvar uu____14077 ->
        FStar_Syntax_Syntax.delta_equational
    | FStar_Syntax_Syntax.Tm_unknown  -> FStar_Syntax_Syntax.delta_equational
    | FStar_Syntax_Syntax.Tm_type uu____14090 ->
        FStar_Syntax_Syntax.delta_constant
    | FStar_Syntax_Syntax.Tm_quoted uu____14091 ->
        FStar_Syntax_Syntax.delta_constant
    | FStar_Syntax_Syntax.Tm_constant uu____14098 ->
        FStar_Syntax_Syntax.delta_constant
    | FStar_Syntax_Syntax.Tm_arrow uu____14099 ->
        FStar_Syntax_Syntax.delta_constant
    | FStar_Syntax_Syntax.Tm_uinst (t2,uu____14115) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_refine
        ({ FStar_Syntax_Syntax.ppname = uu____14120;
           FStar_Syntax_Syntax.index = uu____14121;
           FStar_Syntax_Syntax.sort = t2;_},uu____14123)
        -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_meta (t2,uu____14132) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_ascribed (t2,uu____14138,uu____14139) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_app (t2,uu____14181) -> delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_abs (uu____14206,t2,uu____14208) ->
        delta_qualifier t2
    | FStar_Syntax_Syntax.Tm_let (uu____14233,t2) -> delta_qualifier t2
...
let (incr_delta_qualifier :
  FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.delta_depth) =
  fun t  ->
    let uu____14272 = delta_qualifier t  in incr_delta_depth uu____14272
...
let rec apply_last :
  'Auu____14295 .
    ('Auu____14295 -> 'Auu____14295) ->
      'Auu____14295 Prims.list -> 'Auu____14295 Prims.list
  =
  fun f  ->
    fun l  ->
      match l with
      | [] -> failwith "apply_last: got empty list"
      | a::[] -> let uu____14321 = f a  in [uu____14321]
      | x::xs -> let uu____14326 = apply_last f xs  in x :: uu____14326
            ...
            let uu____14388 =
              let uu____14389 =
                FStar_Syntax_Syntax.lid_as_fv l1
                  ...
                  (FStar_Pervasives_Native.Some FStar_Syntax_Syntax.Data_ctor)
                 in
              FStar_Syntax_Syntax.Tm_fvar uu____14389  in
            FStar_Syntax_Syntax.mk uu____14388  in
          uu____14381 FStar_Pervasives_Native.None rng  in
        let cons1 args pos =
          let uu____14403 =
            let uu____14408 =
              let uu____14409 = ctor FStar_Parser_Const.cons_lid  in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____14409
                [FStar_Syntax_Syntax.U_zero]
               in
            FStar_Syntax_Syntax.mk_Tm_app uu____14408 args  in
          uu____14403 FStar_Pervasives_Native.None pos  in
        let nil args pos =
          let uu____14423 =
            let uu____14428 =
              let uu____14429 = ctor FStar_Parser_Const.nil_lid  in
              FStar_Syntax_Syntax.mk_Tm_uinst uu____14429
                [FStar_Syntax_Syntax.U_zero]
               in
            FStar_Syntax_Syntax.mk_Tm_app uu____14428 args  in
          uu____14423 FStar_Pervasives_Native.None pos  in
        let uu____14430 =
          let uu____14431 =
            let uu____14432 = FStar_Syntax_Syntax.iarg typ  in [uu____14432]
             in
          nil uu____14431 rng  in
        FStar_List.fold_right
          (fun t  ->
             fun a  ->
               let uu____14466 =
                 let uu____14467 = FStar_Syntax_Syntax.iarg typ  in
                 let uu____14476 =
                   let uu____14487 = FStar_Syntax_Syntax.as_arg t  in
                   let uu____14496 =
                     let uu____14507 = FStar_Syntax_Syntax.as_arg a  in
                     [uu____14507]  in
                   uu____14487 :: uu____14496  in
                 uu____14467 :: uu____14476  in
               cons1 uu____14466 t.FStar_Syntax_Syntax.pos) l uu____14430
  ...
  fun msg  ->
    fun cond  ->
      ...
      then true
        ...
        ((let uu____14934 = FStar_ST.op_Bang debug_term_eq  in
          if uu____14934
    ...
    fun t1  ->
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_delayed uu____15201,uu____15202) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____15227,FStar_Syntax_Syntax.Tm_delayed uu____15228) ->
            failwith "term_eq: impossible, should have been removed"
        | (FStar_Syntax_Syntax.Tm_ascribed uu____15253,uu____15254) ->
            failwith "term_eq: impossible, should have been removed"
        | (uu____15283,FStar_Syntax_Syntax.Tm_ascribed uu____15284) ->
            failwith "term_eq: impossible, should have been removed"
        ...
        | (FStar_Syntax_Syntax.Tm_fvar x,FStar_Syntax_Syntax.Tm_fvar y) ->
            let uu____15323 = FStar_Syntax_Syntax.fv_eq x y  in
            check "fvar" uu____15323
        | (FStar_Syntax_Syntax.Tm_constant c1,FStar_Syntax_Syntax.Tm_constant
           c2) ->
            let uu____15328 = FStar_Const.eq_const c1 c2  in
            check "const" uu____15328
        | (FStar_Syntax_Syntax.Tm_type
           uu____15331,FStar_Syntax_Syntax.Tm_type uu____15332) -> true
        | (FStar_Syntax_Syntax.Tm_abs (b1,t12,k1),FStar_Syntax_Syntax.Tm_abs
           (b2,t22,k2)) ->
            (let uu____15390 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "abs binders" uu____15390) &&
              (let uu____15400 = term_eq_dbg dbg t12 t22  in
               check "abs bodies" uu____15400)
        | (FStar_Syntax_Syntax.Tm_arrow (b1,c1),FStar_Syntax_Syntax.Tm_arrow
           (b2,c2)) ->
            (let uu____15449 = eqlist (binder_eq_dbg dbg) b1 b2  in
             check "arrow binders" uu____15449) &&
              (let uu____15459 = comp_eq_dbg dbg c1 c2  in
               check "arrow comp" uu____15459)
        | (FStar_Syntax_Syntax.Tm_refine
           (b1,t12),FStar_Syntax_Syntax.Tm_refine (b2,t22)) ->
            (check "refine bv"
               (b1.FStar_Syntax_Syntax.index = b2.FStar_Syntax_Syntax.index))
              &&
              (let uu____15477 = term_eq_dbg dbg t12 t22  in
               check "refine formula" uu____15477)
        | (FStar_Syntax_Syntax.Tm_app (f1,a1),FStar_Syntax_Syntax.Tm_app
           (f2,a2)) ->
            (let uu____15534 = term_eq_dbg dbg f1 f2  in
             check "app head" uu____15534) &&
              (let uu____15538 = eqlist (arg_eq_dbg dbg) a1 a2  in
               check "app args" uu____15538)
        | (FStar_Syntax_Syntax.Tm_match
           (t12,bs1),FStar_Syntax_Syntax.Tm_match (t22,bs2)) ->
            (let uu____15627 = term_eq_dbg dbg t12 t22  in
             check "match head" uu____15627) &&
              (let uu____15631 = eqlist (branch_eq_dbg dbg) bs1 bs2  in
               check "match branches" uu____15631)
        | (FStar_Syntax_Syntax.Tm_lazy uu____15648,uu____15649) ->
            let uu____15650 =
              let uu____15652 = unlazy t11  in
              term_eq_dbg dbg uu____15652 t21  in
            check "lazy_l" uu____15650
        | (uu____15654,FStar_Syntax_Syntax.Tm_lazy uu____15655) ->
            let uu____15656 =
              let uu____15658 = unlazy t21  in
              term_eq_dbg dbg t11 uu____15658  in
            check "lazy_r" uu____15656
        | (FStar_Syntax_Syntax.Tm_let
           ((b1,lbs1),t12),FStar_Syntax_Syntax.Tm_let ((b2,lbs2),t22)) ->
            ((check "let flag" (b1 = b2)) &&
               (let uu____15703 = eqlist (letbinding_eq_dbg dbg) lbs1 lbs2
                   in
                check "let lbs" uu____15703))
              &&
              (let uu____15707 = term_eq_dbg dbg t12 t22  in
               check "let body" uu____15707)
        | (FStar_Syntax_Syntax.Tm_uvar
           (u1,uu____15711),FStar_Syntax_Syntax.Tm_uvar (u2,uu____15713)) ->
            check "uvar"
        ...
        | (FStar_Syntax_Syntax.Tm_quoted
           (qt1,qi1),FStar_Syntax_Syntax.Tm_quoted (qt2,qi2)) ->
            (let uu____15771 =
               let uu____15773 = eq_quoteinfo qi1 qi2  in uu____15773 = Equal
                in
             check "tm_quoted qi" uu____15771) &&
              (let uu____15776 = term_eq_dbg dbg qt1 qt2  in
               check "tm_quoted payload" uu____15776)
        | (FStar_Syntax_Syntax.Tm_meta (t12,m1),FStar_Syntax_Syntax.Tm_meta
           (t22,m2)) ->
            (match (m1, m2) with
             | (FStar_Syntax_Syntax.Meta_monadic
                (n1,ty1),FStar_Syntax_Syntax.Meta_monadic (n2,ty2)) ->
                 (let uu____15806 = FStar_Ident.lid_equals n1 n2  in
                  check "meta_monadic lid" uu____15806) &&
                   (let uu____15810 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic type" uu____15810)
             | (FStar_Syntax_Syntax.Meta_monadic_lift
                (s1,t13,ty1),FStar_Syntax_Syntax.Meta_monadic_lift
                (s2,t23,ty2)) ->
                 ((let uu____15829 = FStar_Ident.lid_equals s1 s2  in
                   check "meta_monadic_lift src" uu____15829) &&
                    (let uu____15833 = FStar_Ident.lid_equals t13 t23  in
                     check "meta_monadic_lift tgt" uu____15833))
                   &&
                   (let uu____15837 = term_eq_dbg dbg ty1 ty2  in
                    check "meta_monadic_lift type" uu____15837)
             | uu____15840 -> fail "metas")
        | (FStar_Syntax_Syntax.Tm_unknown ,uu____15846) -> fail "unk"
        | (uu____15848,FStar_Syntax_Syntax.Tm_unknown ) -> fail "unk"
        | (FStar_Syntax_Syntax.Tm_bvar uu____15850,uu____15851) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_name uu____15853,uu____15854) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_fvar uu____15856,uu____15857) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_constant uu____15859,uu____15860) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_type uu____15862,uu____15863) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_abs uu____15865,uu____15866) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_arrow uu____15886,uu____15887) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_refine uu____15903,uu____15904) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_app uu____15912,uu____15913) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_match uu____15931,uu____15932) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_let uu____15956,uu____15957) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_uvar uu____15972,uu____15973) ->
            fail "bottom"
        | (FStar_Syntax_Syntax.Tm_meta uu____15987,uu____15988) ->
            fail "bottom"
        | (uu____15996,FStar_Syntax_Syntax.Tm_bvar uu____15997) ->
            fail "bottom"
        | (uu____15999,FStar_Syntax_Syntax.Tm_name uu____16000) ->
            fail "bottom"
        | (uu____16002,FStar_Syntax_Syntax.Tm_fvar uu____16003) ->
            fail "bottom"
        | (uu____16005,FStar_Syntax_Syntax.Tm_constant uu____16006) ->
            fail "bottom"
        | (uu____16008,FStar_Syntax_Syntax.Tm_type uu____16009) ->
            fail "bottom"
        | (uu____16011,FStar_Syntax_Syntax.Tm_abs uu____16012) ->
            fail "bottom"
        | (uu____16032,FStar_Syntax_Syntax.Tm_arrow uu____16033) ->
            fail "bottom"
        | (uu____16049,FStar_Syntax_Syntax.Tm_refine uu____16050) ->
            fail "bottom"
        | (uu____16058,FStar_Syntax_Syntax.Tm_app uu____16059) ->
            fail "bottom"
        | (uu____16077,FStar_Syntax_Syntax.Tm_match uu____16078) ->
            fail "bottom"
        | (uu____16102,FStar_Syntax_Syntax.Tm_let uu____16103) ->
            fail "bottom"
        | (uu____16118,FStar_Syntax_Syntax.Tm_uvar uu____16119) ->
            fail "bottom"
        | (uu____16133,FStar_Syntax_Syntax.Tm_meta uu____16134) ->
            fail "bottom"
    ...
    fun a1  ->
      fun a2  ->
        eqprod
          (fun t1  ->
             fun t2  ->
               let uu____16169 = term_eq_dbg dbg t1 t2  in
               check "arg tm" uu____16169)
          (fun q1  ->
             fun q2  ->
               let uu____16181 =
                 let uu____16183 = eq_aqual q1 q2  in uu____16183 = Equal  in
               check "arg qual" uu____16181) a1 a2
             ...
             fun b21  ->
               let uu____16208 =
                 term_eq_dbg dbg b11.FStar_Syntax_Syntax.sort
                  ...
                  in
               check "binder sort" uu____16208)
          (fun q1  ->
             fun q2  ->
               let uu____16220 =
                 let uu____16222 = eq_aqual q1 q2  in uu____16222 = Equal  in
               check "binder qual" uu____16220) b1 b2
      ...
      fun c2  ->
        ...
        ((let uu____16242 =
            FStar_Ident.lid_equals c11.FStar_Syntax_Syntax.effect_name
             ...
             in
          check "comp eff" uu____16242) &&
           (let uu____16246 =
              term_eq_dbg dbg c11.FStar_Syntax_Syntax.result_typ
                c21.FStar_Syntax_Syntax.result_typ
               in
            check "comp result typ" uu____16246))
          && true
...
and (branch_eq_dbg :
  ...
  fun dbg  ->
    fun uu____16256  ->
      fun uu____16257  ->
        match (uu____16256, uu____16257) with
        | ((p1,w1,t1),(p2,w2,t2)) ->
            ((let uu____16384 = FStar_Syntax_Syntax.eq_pat p1 p2  in
              check "branch pat" uu____16384) &&
               (let uu____16388 = term_eq_dbg dbg t1 t2  in
                check "branch body" uu____16388))
              &&
              (let uu____16392 =
                 match (w1, w2) with
                 | (FStar_Pervasives_Native.Some
      ...
      fun lb2  ->
        ((let uu____16455 =
            eqsum (fun bv1  -> fun bv2  -> true) FStar_Syntax_Syntax.fv_eq
             ...
             in
          check "lb bv" uu____16455) &&
           (let uu____16464 =
              term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbtyp
                lb2.FStar_Syntax_Syntax.lbtyp
               in
            check "lb typ" uu____16464))
          &&
          (let uu____16468 =
             term_eq_dbg dbg lb1.FStar_Syntax_Syntax.lbdef
               lb2.FStar_Syntax_Syntax.lbdef
              in
           check "lb def" uu____16468)
...
let (term_eq :
  ...
  fun t1  ->
    fun t2  ->
      let r =
        let uu____16485 = FStar_ST.op_Bang debug_term_eq  in
        term_eq_dbg uu____16485 t1 t2  in
      FStar_ST.op_Colon_Equals debug_term_eq false; r
  
let rec (sizeof : FStar_Syntax_Syntax.term -> Prims.int) =
  fun t  ->
    match t.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.Tm_delayed uu____16539 ->
        let uu____16562 =
          let uu____16564 = FStar_Syntax_Subst.compress t  in
          sizeof uu____16564  in
        (Prims.parse_int "1") + uu____16562
    | FStar_Syntax_Syntax.Tm_bvar bv ->
        let uu____16567 = sizeof bv.FStar_Syntax_Syntax.sort  in
        (Prims.parse_int "1") + uu____16567
    | FStar_Syntax_Syntax.Tm_name bv ->
        let uu____16571 = sizeof bv.FStar_Syntax_Syntax.sort  in
        (Prims.parse_int "1") + uu____16571
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) ->
        let uu____16580 = sizeof t1  in (FStar_List.length us) + uu____16580
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____16584) ->
        let uu____16609 = sizeof t1  in
        let uu____16611 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____16626  ->
                 ...
                 | (bv,uu____16636) ->
                     let uu____16641 = sizeof bv.FStar_Syntax_Syntax.sort  in
                     acc + uu____16641) (Prims.parse_int "0") bs
           in
        uu____16609 + uu____16611
    | FStar_Syntax_Syntax.Tm_app (hd1,args) ->
        let uu____16670 = sizeof hd1  in
        let uu____16672 =
          FStar_List.fold_left
            (fun acc  ->
               fun uu____16687  ->
                 ...
                 | (arg,uu____16697) ->
                     let uu____16702 = sizeof arg  in acc + uu____16702)
            (Prims.parse_int "0") args
           in
        uu____16670 + uu____16672
    | uu____16705 -> (Prims.parse_int "1")
...
let (is_fvar : FStar_Ident.lident -> FStar_Syntax_Syntax.term -> Prims.bool)
  ...
  fun lid  ->
    fun t  ->
      let uu____16719 =
        let uu____16720 = un_uinst t  in uu____16720.FStar_Syntax_Syntax.n
         in
  ...
  fun p  ->
    fun r  ->
      let set_options1 t s =
        let uu____16774 = FStar_Options.set_options t s  in
      ...
      | FStar_Syntax_Syntax.ResetOptions sopt ->
          ((let uu____16791 = FStar_Options.restore_cmd_line_options false
               in
            FStar_All.pipe_right uu____16791 (fun a1  -> ()));
           (match sopt with
            | FStar_Pervasives_Native.None  -> ()
      ...
      | FStar_Syntax_Syntax.PopOptions  ->
          let uu____16806 = FStar_Options.internal_pop ()  in
          if uu____16806
          then ()
          else
            FStar_Errors.raise_error
...
let rec (unbound_variables :
  ...
  fun tm  ->
    ...
    | FStar_Syntax_Syntax.Tm_uvar uu____16865 -> []
    | FStar_Syntax_Syntax.Tm_type u -> []
    | FStar_Syntax_Syntax.Tm_bvar x -> [x]
    | FStar_Syntax_Syntax.Tm_fvar uu____16880 -> []
    | FStar_Syntax_Syntax.Tm_constant uu____16881 -> []
    | FStar_Syntax_Syntax.Tm_lazy uu____16882 -> []
    | FStar_Syntax_Syntax.Tm_unknown  -> []
    | FStar_Syntax_Syntax.Tm_uinst (t1,us) -> unbound_variables t1
    | FStar_Syntax_Syntax.Tm_abs (bs,t1,uu____16891) ->
        let uu____16916 = FStar_Syntax_Subst.open_term bs t1  in
         ...
         | (bs1,t2) ->
             let uu____16925 =
               FStar_List.collect
                ...
                in
             let uu____16952 = unbound_variables t2  in
             FStar_List.append uu____16925 uu____16952)
    | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
               ...
               FStar_List.collect
                 (fun uu____16998  ->
                    ...
                    | (b,uu____17008) ->
                        unbound_variables b.FStar_Syntax_Syntax.sort) bs1
                in
             let uu____17013 = unbound_variables_comp c1  in
             FStar_List.append uu____16986 uu____17013)
         ...
         | (bs,t2) ->
             let uu____17045 =
               FStar_List.collect
                ...
                in
             let uu____17072 = unbound_variables t2  in
             FStar_List.append uu____17045 uu____17072)
    | FStar_Syntax_Syntax.Tm_app (t1,args) ->
        let uu____17101 =
          FStar_List.collect
            (fun uu____17115  ->
               match uu____17115 with
               | (x,uu____17127) -> unbound_variables x) args
           in
        let uu____17136 = unbound_variables t1  in
        FStar_List.append uu____17101 uu____17136
    | FStar_Syntax_Syntax.Tm_match (t1,pats) ->
        let uu____17177 = unbound_variables t1  in
        let uu____17180 =
          FStar_All.pipe_right pats
            (FStar_List.collect
               (fun br  ->
                  let uu____17195 = FStar_Syntax_Subst.open_branch br  in
                  ...
                  | (p,wopt,t2) ->
                      ...
                      let uu____17220 =
                        ...
                        | FStar_Pervasives_Native.Some t3 ->
                         ...
                         in
                      FStar_List.append uu____17217 uu____17220))
           in
        FStar_List.append uu____17177 uu____17180
    | FStar_Syntax_Syntax.Tm_ascribed (t1,asc,uu____17234) ->
        let uu____17275 = unbound_variables t1  in
        let uu____17278 =
          let uu____17281 =
          ...
          FStar_List.append uu____17281 uu____17312  in
        FStar_List.append uu____17275 uu____17278
    | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),t1) ->
        let uu____17353 = unbound_variables lb.FStar_Syntax_Syntax.lbtyp  in
        let uu____17356 =
          let uu____17359 = unbound_variables lb.FStar_Syntax_Syntax.lbdef
             in
          let uu____17362 =
            match lb.FStar_Syntax_Syntax.lbname with
            | FStar_Util.Inr uu____17367 -> unbound_variables t1
            | FStar_Util.Inl bv ->
                let uu____17369 =
                ...
                (match uu____17369 with
                 | (uu____17390,t2) -> unbound_variables t2)
             in
          FStar_List.append uu____17359 uu____17362  in
        FStar_List.append uu____17353 uu____17356
    | FStar_Syntax_Syntax.Tm_let ((uu____17392,lbs),t1) ->
        let uu____17412 = FStar_Syntax_Subst.open_let_rec lbs t1  in
        (match uu____17412 with
         | (lbs1,t2) ->
             let uu____17427 = unbound_variables t2  in
             let uu____17430 =
               FStar_List.collect
                 (fun lb  ->
                    let uu____17437 =
                    ...
                    FStar_List.append uu____17437 uu____17440) lbs1
                in
    ...
    | FStar_Syntax_Syntax.Tm_meta (t1,m) ->
        let uu____17457 = unbound_variables t1  in
        let uu____17460 =
          match m with
          | FStar_Syntax_Syntax.Meta_pattern (attr,uu____17466,args) ->
              FStar_List.collect
                (FStar_List.collect
                   (fun uu____17525  ->
                      match uu____17525 with
                      | (a,uu____17537) -> unbound_variables a)) args
          | FStar_Syntax_Syntax.Meta_monadic_lift
              (uu____17546,uu____17547,t') -> unbound_variables t'
          | FStar_Syntax_Syntax.Meta_monadic (uu____17553,t') ->
              unbound_variables t'
          | FStar_Syntax_Syntax.Meta_labeled uu____17559 -> []
          | FStar_Syntax_Syntax.Meta_desugared uu____17568 -> []
          | FStar_Syntax_Syntax.Meta_named uu____17569 -> []  in
        FStar_List.append uu____17457 uu____17460
...
and (unbound_variables_comp :
  ...
  fun c  ->
    match c.FStar_Syntax_Syntax.n with
    | FStar_Syntax_Syntax.GTotal (t,uu____17576) -> unbound_variables t
    | FStar_Syntax_Syntax.Total (t,uu____17586) -> unbound_variables t
    | FStar_Syntax_Syntax.Comp ct ->
        let uu____17596 = unbound_variables ct.FStar_Syntax_Syntax.result_typ
           in
        let uu____17599 =
          FStar_List.collect
            (fun uu____17613  ->
               match uu____17613 with
               | (a,uu____17625) -> unbound_variables a)
  ...
  fun attr_lid  ->
    fun attrs  ->
      let rec aux acc attrs1 =
        ...
        | [] -> FStar_Pervasives_Native.None
        | h::t ->
            let uu____17740 = head_and_args h  in
            (match uu____17740 with
             | (head1,args) ->
                 let uu____17801 =
                   let uu____17802 = FStar_Syntax_Subst.compress head1  in
  ...
  fun attr_lid  ->
    fun se  ->
      ...
      | FStar_Pervasives_Native.Some (attrs',t) ->
          FStar_Pervasives_Native.Some
            ((let uu___2549_17921 = se  in
              {
                FStar_Syntax_Syntax.sigel =
                  (uu___2549_17921.FStar_Syntax_Syntax.sigel);
                FStar_Syntax_Syntax.sigrng =
                  (uu___2549_17921.FStar_Syntax_Syntax.sigrng);
                FStar_Syntax_Syntax.sigquals =
                  (uu___2549_17921.FStar_Syntax_Syntax.sigquals);
                FStar_Syntax_Syntax.sigmeta =
                  (uu___2549_17921.FStar_Syntax_Syntax.sigmeta);
...
let (is_smt_lemma : FStar_Syntax_Syntax.term -> Prims.bool) =
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_arrow (uu____17934,c) ->
        (match c.FStar_Syntax_Syntax.n with
         | FStar_Syntax_Syntax.Comp ct when
             ...
             (match ct.FStar_Syntax_Syntax.effect_args with
              | _req::_ens::(pats,uu____17962)::uu____17963 ->
                  let pats' = unmeta pats  in
                  let uu____18023 = head_and_args pats'  in
                  (match uu____18023 with
                   | (head1,uu____18042) ->
                       let uu____18067 =
                         let uu____18068 = un_uinst head1  in
...
let rec (list_elements :
  ...
  fun e  ->
    let uu____18105 =
      let uu____18122 = unmeta e  in head_and_args uu____18122  in
    ...
    | (head1,args) ->
        ...
        (match uu____18153 with
         | (FStar_Syntax_Syntax.Tm_fvar fv,uu____18187) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.nil_lid ->
             FStar_Pervasives_Native.Some []
         | (FStar_Syntax_Syntax.Tm_fvar
            fv,uu____18211::(hd1,uu____18213)::(tl1,uu____18215)::[]) when
             FStar_Syntax_Syntax.fv_eq_lid fv FStar_Parser_Const.cons_lid ->
             let uu____18282 =
               let uu____18285 =
                 let uu____18288 = list_elements tl1  in
                 FStar_Util.must uu____18288  in
               hd1 :: uu____18285  in
...
let (unthunk_lemma_post :
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_abs (b::[],e,uu____18334) ->
        let uu____18369 = FStar_Syntax_Subst.open_term [b] e  in
        (match uu____18369 with
         | (bs,e1) ->
             let b1 = FStar_List.hd bs  in
             let uu____18403 = is_free_in (FStar_Pervasives_Native.fst b1) e1
                in
             if uu____18403
             then
               let uu____18410 =
                 let uu____18421 = FStar_Syntax_Syntax.as_arg exp_unit  in
                 [uu____18421]  in
               mk_app t uu____18410
             else e1)
    | uu____18448 ->
        let uu____18449 =
          let uu____18460 = FStar_Syntax_Syntax.as_arg exp_unit  in
          [uu____18460]  in
        mk_app t uu____18449
  ...
  fun t  ->
    fun universe_of_binders  ->
      let list_elements1 e =
        let uu____18515 = list_elements e  in
      ...
      let one_pat p =
        let uu____18546 =
          let uu____18563 = unmeta p  in
          FStar_All.pipe_right uu____18563 head_and_args  in
        match uu____18546 with
        | (head1,args) ->
            let uu____18614 =
              let uu____18629 =
                let uu____18630 = un_uinst head1  in
                uu____18630.FStar_Syntax_Syntax.n  in
              (uu____18629, args)  in
            (match uu____18614 with
             | (FStar_Syntax_Syntax.Tm_fvar
                fv,(uu____18652,uu____18653)::arg::[]) when
                 FStar_Syntax_Syntax.fv_eq_lid fv
                   FStar_Parser_Const.smtpat_lid
                 -> arg
             | uu____18705 -> failwith "Unexpected pattern term")
         in
      let lemma_pats p =
        let elts = list_elements1 p  in
        let smt_pat_or1 t1 =
          let uu____18760 =
            let uu____18777 = unmeta t1  in
            FStar_All.pipe_right uu____18777 head_and_args  in
          match uu____18760 with
          | (head1,args) ->
              let uu____18824 =
                let uu____18839 =
                  let uu____18840 = un_uinst head1  in
                  uu____18840.FStar_Syntax_Syntax.n  in
                (uu____18839, args)  in
              (match uu____18824 with
               | (FStar_Syntax_Syntax.Tm_fvar fv,(e,uu____18859)::[]) when
                   FStar_Syntax_Syntax.fv_eq_lid fv
                     FStar_Parser_Const.smtpatOr_lid
                   -> FStar_Pervasives_Native.Some e
               | uu____18896 -> FStar_Pervasives_Native.None)
           in
        match elts with
        | t1::[] ->
            let uu____18926 = smt_pat_or1 t1  in
            (match uu____18926 with
             | FStar_Pervasives_Native.Some e ->
                 let uu____18948 = list_elements1 e  in
                 FStar_All.pipe_right uu____18948
                   (FStar_List.map
                      (fun branch1  ->
                         let uu____18978 = list_elements1 branch1  in
      ...
      let uu____19111 =
        let uu____19144 =
          let uu____19145 = FStar_Syntax_Subst.compress t  in
          uu____19145.FStar_Syntax_Syntax.n  in
        match uu____19144 with
        | FStar_Syntax_Syntax.Tm_arrow (binders,c) ->
            let uu____19202 = FStar_Syntax_Subst.open_comp binders c  in
            (match uu____19202 with
             | (binders1,c1) ->
                 (match c1.FStar_Syntax_Syntax.n with
                  | FStar_Syntax_Syntax.Comp
                      { FStar_Syntax_Syntax.comp_univs = uu____19273;
                        FStar_Syntax_Syntax.effect_name = uu____19274;
                        FStar_Syntax_Syntax.result_typ = uu____19275;
                        FStar_Syntax_Syntax.effect_args =
                          (pre,uu____19277)::(post,uu____19279)::(pats,uu____19281)::[];
                        FStar_Syntax_Syntax.flags = uu____19282;_}
                      ->
                      let uu____19343 = lemma_pats pats  in
                      (binders1, pre, post, uu____19343)
                  | uu____19380 -> failwith "impos"))
        | uu____19414 -> failwith "Impos"  in
      ...
      | (binders,pre,post,patterns) ->
          ...
          let body =
            let uu____19506 =
              let uu____19513 =
                let uu____19514 =
                  let uu____19521 = mk_imp pre post1  in
                  let uu____19524 =
                    let uu____19525 =
                      let uu____19550 =
                        FStar_Syntax_Syntax.binders_to_names binders  in
                      (FStar_Pervasives_Native.None, uu____19550, patterns)
                       in
                    FStar_Syntax_Syntax.Meta_pattern uu____19525  in
                  (uu____19521, uu____19524)  in
                FStar_Syntax_Syntax.Tm_meta uu____19514  in
              FStar_Syntax_Syntax.mk uu____19513  in
            uu____19506 FStar_Pervasives_Native.None
              t.FStar_Syntax_Syntax.pos
             in
          let quant =
            let uu____19576 = universe_of_binders binders  in
            FStar_List.fold_right2
              (fun b  ->
                 fun u  ->
                   fun out  ->
